...
for binary in wiidesk-x11 wiidesk-x11-app wiidesk-session-health wiidesk-x11-image wiidesk-x11-archive wiidesk-x11-packages wiidesk-package-install wiidesk-package-terminal wiidesk-x11-audio wiidesk-audio-worker; do
